        ...
        <div className="header-top">
            <div className="container-fluid">
                ...
                <div className="col-xl-6 col-md-12 htleft d-xl-flex align-self-center text-center text-xl-start">
                    ...
                    <li>
                        <i className="fa-solid fa fa-location-dot"></i> 3500 Lenox Road , USA
                    </li>
                    </ul>
                </div>
                {/* End Col */}
                ...
                <div className="bis_himage">
                    <img src="/assets/img/icons/bismillah.svg" alt="Bismillah" />
                </div>
                    ...
                    <div className="header-left d-flex justify-content-center">
                        ...
                        <ul>
                            ...
                            <ul className="sub-menu">
                                <li><Link href="/">Home Slider</Link></li>
                                <li><Link href="/home-2">Home Banner</Link></li>
                            </ul>
                            </li>
