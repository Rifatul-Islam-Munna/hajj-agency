...
export default function BookingCartView() {
  ...
  if (!item) return <section className="shopping-cart section-padding"><div className="container"><div className="booking-empty"><h3>Your booking cart is empty</h3><p>Select a Hajj or Umrah package to continue.</p><Link href="/packages" className="green_btn"><span>Browse Packages</span></Link></div></div></section>;
