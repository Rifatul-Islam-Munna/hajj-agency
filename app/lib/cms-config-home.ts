...
export const HOME_CMS_PAGES: CmsPageSeed[] = [
  {
    ...
    name: "Home (Slider)",
    route: "/",
    seoTitle: "Hajj & Umrah Agency",
    seoDescription: "Trusted Hajj and Umrah packages, guidance and travel support.",
    sections: [{ key: "slider", name: "Hero Slider" }, ...shared],
  },
  {
    slug: "home-2",
    name: "Home (Banner)",
    route: "/home-2",
    seoTitle: "Hajj & Umrah Agency",
    seoDescription: "Plan your sacred journey with trusted travel specialists.",
    sections: [{ key: "home-banner", name: "Hero Banner" }, ...shared],
  },
];
