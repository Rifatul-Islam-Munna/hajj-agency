...
export async function deleteContentRecord(id: number) { await ensureExtendedCmsStorage(); await query<ResultSetHeader>("DELETE FROM content_records WHERE id = ?", [id]); }
