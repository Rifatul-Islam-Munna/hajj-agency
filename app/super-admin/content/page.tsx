import { CircleHelp, Columns3, HandHeart, Images, Link2, MessageSquareQuote, Music2, UserRoundCheck } from "lucide-react";
import Link from "next/link";

const sections = [
  { slug: "slider", title: "Hero Slider", text: "Add, edit and reorder homepage slider items.", icon: Images },
  { slug: "audio", title: "Audio Player", text: "Add Quran audio titles and audio URLs for the About player.", icon: Music2 },
