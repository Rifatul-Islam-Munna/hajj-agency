  ...
  return (
    <section className="admin-section-card">
      <div className="admin-section-head">
        <div>
          <h3><Search size={19} /> Page and complete SEO</h3>
      ...
      <div className="admin-subsection-title"><Search size={17} /> Search result</div>
      ...
      <div className="admin-subsection-title"><Share2 size={17} /> Facebook, LinkedIn and WhatsApp</div>
      <div className="admin-fields">
        ...
        <ImageUploadField label="Open Graph image" value={page.og_image} onChange={(value) => onChange("og_image", value)} recommended="1200 × 630 px" />
      </div>

      <div className="admin-subsection-title"><Share2 size={17} /> X / Twitter card</div>
      <div className="admin-fields">
        ...
        <ImageUploadField label="Twitter image" value={page.twitter_image} onChange={(value) => onChange("twitter_image", value)} recommended="1200 × 675 px" />
      </div>

      <div className="admin-subsection-title"><Bot size={17} /> Search engine crawling</div>
      ...
      <div className="admin-subsection-title"><Code2 size={17} /> JSON-LD structured data</div>
      <div className="admin-fields">
