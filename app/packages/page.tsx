...
export const generateMetadata = () => cmsMetadata(
  ...
  "Browse our available pilgrimage travel packages.",
);
...
export default async function PackagesPage() {
  ...
  return (
    <CmsPageProvider page={page}>
      <Header />
      <CmsSection sectionKey="banner"><Banner title="Packages" /></CmsSection>
      <CmsSection sectionKey="packages-grid"><PackagesSection featuredOnly={false} /></CmsSection>
      <Footer />
    </CmsPageProvider>
  );
}
