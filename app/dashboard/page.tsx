...
export default async function DashboardPage() {
  ...
  return <><Header /><Banner title="Dashboard" /><section className="section-padding"><div className="container">
    <div className="dashboard-head mb-4"><div><h1>My Dashboard</h1><p>Your bookings and payment status.</p></div><Link href="/packages" className="green_btn"><span>Browse Packages</span></Link></div>
